...
def test_user_query_is_none():
    ...
    assert result == ("You didn't search for anything! Try to put something in to the search bar! 🔍", "If you think there is a bug, please use the Contact Me form and write to me", "break computer.gif", 422)
...
def test_user_query_is_str_type():
    ...
    assert result == ("You encountered an error and I have no idea how you got here 😱", "Could you please contact me via the Contact Me page to help me fix it? Thanks!", "break computer.gif", 422)
...
def test_page_is_not_int():
    ...
    assert result == ("You are looking for a non existing page", "If you think there is a bug, please use the Contact Me form and write to me", "break computer.gif", 422)
...
def test_page_is_in_range():
    ...
    assert result == ("No more pages to display 😱", "Only 34 pages are allowed due to API limitations! Stop hacking my website! 🔨", "break computer.gif", 422)
